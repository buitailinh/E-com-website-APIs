...
exports.AppKey = void 0;
var AppKey = /** @class */ (function () {
    function AppKey() {
    }
    AppKey.TABLES = {
        /* PLOP_INJECT_TABLE */
    ...
    AppKey.ERROR_MESSAGE = {
        ...
        ITEM: {
            ERR_EXIST: ' ITEM already exists!',
            ERR_NOT_EXIST: ' ITEM is not exists!',
            ERR_ID_NOT_VALID: 'Id  ITEM not valid!',
            ERR_NAMEITEM_EXIST: 'NAME ITEM already exists!',
            ERR_BARCODE_EXIST: 'BARCODE ITEM already exists!',
            ERR_NUMBER_VALUE: 'NUMBER  ITEM already exists!',
            ERR_CANT_CHANGE_ROLE: 'Can not change role!',
            ERR_PRICE: 'The selling price must be greater than or equal to the import price',
            ERR_REFERRAL_CODE_WRONG: 'Wrong referral code. Please try again!'
        },
        CATEGORY: {
        ...
        IMAGE: {
            ERR_EXIST: ' Image  already exists!',
            ERR_NOT_EXIST: ' Image is not exists!',

...
var ForgetPassword = /** @class */ (function () {
    ...
    ], ForgetPassword.prototype, "email");
    __decorate([
    ...
    ], ForgetPassword.prototype, "newPassword");
    __decorate([
        swagger_1.ApiProperty({ required: true, description: 'OTP key' }),
        class_validator_1.IsNotEmpty({ message: "OTP is not empty" }),
        class_validator_1.IsString()
    ], ForgetPassword.prototype, "OTP");

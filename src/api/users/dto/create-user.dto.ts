...
export class CreateUserDto {
    ...
    @ApiProperty({ type: 'string', required: true, description: 'your fullname ', example: 'example', minLength: 2 })
    ...
    @ApiProperty({ required: false, description: ' address', type: 'string', example: '123 Main St' })
